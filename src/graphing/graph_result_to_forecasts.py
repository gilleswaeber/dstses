...
async def main():
	...
	forecaster = forecast.head(n=50)
	forecaster.rename_axis("time", axis=0, inplace=True)
	forecaster.rename_axis("predictions", axis=1, inplace=True)

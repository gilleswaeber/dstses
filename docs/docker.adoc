...
The system contains an image that automatically installs jupiter and runs it as soon as you start the container. So you can benefit from the http server to edit your files.
